...
$_rwlinks = array(
   ...
   // 'depo/calc' => array('calc'),
    ...
    'about' => array('about'),
    'about/show' => array('show'),
    'about/admin/aboutes' => array('admin/aboutes', 'admin' => '{!ru!}О нас{!en!}About{!!}/{!ru!}Пукация{!en!}Publications'),
    'about/admin/about' => array('admin/about', 'admin' => '{!ru!}О нас{!en!}About{!!}/-'),
    'about/admin/setup' => array('admin/about/setup', 'admin' => '{!ru!}О нас{!en!}About{!!}/{!ru!}Настройки{!en!}Settings'),


    //Contract

    'contract' => array('contract'),
    'contract/show' => array('show'),
    'contract/admin/contractes' => array('admin/contractes', 'admin' => '{!ru!}Договор{!en!}About{!!}/{!ru!}Пукация{!en!}Publications'),
    'contract/admin/contract' => array('admin/contract', 'admin' => '{!ru!}Договор{!en!}Contract{!!}/-'),
    'contract/admin/setup' => array('admin/contract/setup', 'admin' => '{!ru!}Договор{!en!}Contract{!!}/{!ru!}Настройки{!en!}Settings'),
